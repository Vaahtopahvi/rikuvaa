      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="flex justify-center">
          ...
          <div className="flex w-full aspect-square rounded-2xl bg-[oklch(0.3943_0.0647_203.9)] dark:bg-[oklch(0.3943_0.0647_203.9)] shadow-lg justify-center items-center p-14">
            ...
            <div className="bg-white dark:bg-[var(--background)] rounded-2xl w-full h-full flex justify-center items-center">
              <img
                src={profileImage}
                alt="riku in Suomenlinna"
        ...
        <div className="text-lg">
          ...
          <p className="text-gray-700 dark:text-gray-300">
            ...
            I’ve switched to using Linux as my primary OS, valuing its
            efficiency and alignment with my personal values, such as privacy.
          </p>
          {/* quick fax */}
